...

{
  ...
  services.hermes-agent = {
    ...
    # 从 SOPS-Nix 恢复已完成的 Nous Portal OAuth 登录状态。
    # false 保证 Hermes 运行时刷新后的 token 不会被每次激活覆盖。
    authFile = "/run/secrets/hermes-auth";
